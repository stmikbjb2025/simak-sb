          ...
          <Controller
            ...
            render={({ field }) => (
              <InputField
                label="NPK"
                name={field.name}
                defaultValue={data?.npk ?? field.value}
                register={register}
                error={errors?.npk}
                required={true}
              />
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputField
                label="NIDN"
                name="nidn"
                defaultValue={data?.nidn ?? field.value}
                register={register}
                error={errors?.nidn}
                required={true}
              />
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputField
                label="NUPTK"
                name="nuptk"
                defaultValue={data?.nuptk ?? field.value}
                register={register}
                error={errors?.nuptk}
              />
            )}
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputField
                ...
                name={field.name}
                defaultValue={data?.frontTitle ?? field.value}
                register={register}
          ...
          <Controller
            ...
            render={({ field }) => (
              <InputField
                ...
                name={field.name}
                defaultValue={data?.backTitle ?? field.value}
                register={register}
